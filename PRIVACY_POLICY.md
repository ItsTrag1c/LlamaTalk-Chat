...
- **2026-03-07 (rev. 7)** — Desktop v0.16.0: Added OpenCode cloud provider support. API key stored in OS credential store. OpenCode domain added to cloud URL allowlist.
