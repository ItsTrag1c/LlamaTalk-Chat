...
const installer = `E:\\LlamaTalk Files\\Installers\\Clank Desktop_${version}_x64-setup.exe`;
...
console.log(`Installing Clank Desktop v${version} to Program Files (UAC prompt will appear)...`);
execSync(
